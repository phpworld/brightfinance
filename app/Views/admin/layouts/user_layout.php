      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?= base_url('/admin/kyc'); ?>" aria-expanded="false">
                <span>
			...
			<!---<li class="sidebar-item">
              <a class="sidebar-link" href="<?//= base_url('/my_magzines/') ?>" aria-expanded="false">
                <span>
                  <i class="ti ti-cards"></i>
                </span>
                <span class="hide-menu">User KYC </span>
              </a>
            </li> ---->
			
			<li class="sidebar-item">
              <a class="sidebar-link" href="<?= base_url('admin/search_kyc') ?>" aria-expanded="false">
                <span>
                  <i class="ti ti-file-description"></i>
                </span>
                <span class="hide-menu">Search KYC</span>
              </a>
            </li>
			
			<!--- <li class="sidebar-item">
              <a class="sidebar-link" href="<?= base_url('subscription/manage') ?>" aria-expanded="false">
                <span>
                  <i class="ti ti-article"></i>
                </span>
                <span class="hide-menu">Manage Subscriptions</span>
              </a>
            </li> ---->
            
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?= base_url('user/change-password') ?>" aria-expanded="false">
                <span>
