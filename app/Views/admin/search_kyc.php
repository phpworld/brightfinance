...
<div class="container mt-5">
    <h2 class="mb-4">Search Applications</h2>

    <!-- Search Form -->
    <form method="post" action="<?= base_url('admin/search_kyc') ?>" class="mb-4">
        <div class="row">
            <div class="col-md-4">
            ...
            <tbody>
                <?php $i = 1; foreach ($kycForms as $kyc): ?>
                    <tr>
                        ...
                        <td><?= esc($kyc['email']) ?></td>
                        <td>
                            <a href="<?= base_url('admin/kyc/view/' . $kyc['id']) ?>" class="btn btn-info">View</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
