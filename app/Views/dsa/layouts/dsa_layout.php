          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?= base_url('') ?>" aria-expanded="false">
                ...
                <span class="hide-menu">Apply Loan</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?= base_url('admin/uploadMagazine') ?>" aria-expanded="false">
                ...
                <span class="hide-menu">View Application</span>
              </a>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?= base_url('admin/manageUsers') ?>" aria-expanded="false">
                ...
                <span class="hide-menu">DSA Profiles</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?= base_url('admin/manageSubscriptions') ?>" aria-expanded="false">
                ...
                <span class="hide-menu">Earnings History</span>
              </a>
            </li>
